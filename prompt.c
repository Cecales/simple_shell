...
/**
 * str_concat - concatenates two strings to return a pointer points to a
 * newly allocated space in memory which contains the contents.
 * @s1: string to be modified.
 * @s2: string to be appended.
 * @flag: integer flag for handling path or error function
 * link_s: linked_string (after concatenate).
 * Return: char.
 */
 ...
 * @sig: Variable that contains a character array to be counted
 */
